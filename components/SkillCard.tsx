      ...
      >
        {skillData.map((skill, index) => (
          <motion.div
            ...
            key={skill.name}
            className="flex min-[580px]:flex-row flex-col items-center gap-3.5 min-[580px]:p-3.5 px-2 py-3.5 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 group hover:-translate-y-1.5 transition-all duration-300 ease-out"
          >
            <ShineBorder
