    ...
    <TabsContent value={tabValue} className="max-w-5xl mx-auto mt-16 w-full">
      ...
      >
        {skillData.map((skill, index) => (
          ...
          >
            <div className="flex min-[580px]:flex-row flex-col items-center gap-3.5 min-[580px]:p-3.5 px-2 min-[350px]:py-3.5 py-3 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 group hover:-translate-y-1.5 transition-transform duration-300 ease-in">
              <ShineBorder
                className="opacity-0 group-hover:opacity-100 transition-all duration-200 ease-in"
                shineColor={skill.color}
              />
              <div className="relative min-[654px]:size-11 min-[450px]:size-10 min-[375px]:size-9 size-8 rounded overflow-hidden ">
                <Image
                  src={skill.img}
                  alt={skill.name}
                  fill
              ...
              <div className="flex flex-col min-[580px]:text-start text-center min-[580px]:gap-0.5 gap-1">
                ...
                <p className="hidden min-[580px]:block text-sm text-neutral-300">
                  {skill.desc}
                </p>
              </div>
            </div>
